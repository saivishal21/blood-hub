...
<head>
    ...
    <style>
        ...
        .other-divs.hidden {
            display: none; /* Hide other divs when needed */
        }
    </style>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#emergency').click(function () {
                // Hide other divs when emergency link is clicked
                $(".other-divs").addClass("hidden");

                // Toggle the visibility of the form container
                $('#emergency-form-container').toggle();

                // If the form is shown, load the form dynamically
                if ($('#emergency-form-container').is(':visible')) {
                    $.get('emergency_registration.php', function (data) {
                        $('#emergency-form-container').html(data);
                    });
                }
            });
        });
...
<body>
    <nav class="navbar bg-danger">
        <div class="container-fluid">
            ...
            <ul class="nav navbar">
                ...
                <li class="nav-item">
                    <a class="nav-link" id="emergency">Emergency Available</a>
                </li>
                <li class="nav-item">
    ...
    <!-- Emergency registration form container -->
    <div id="emergency-form-container"></div>

    <div class="container-fluid">
        <div class="row" id="main-container">
            <div class="col-md-2 info_card other-divs">
